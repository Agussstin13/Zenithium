  ...
  const team = [
    {
      ...
      bio: "Full-stack developer especializado en arquitecturas escalables y seguridad.",
      skills: ["React", ".NET", "Docker", "Architecture", "SQL", "Azure"],
    ...
    },
    {
      ...
      bio: "Experto en modelado de datos y optimización de consultas, con foco en escalabilidad en la nube. Stack: SQL, .NET, AWS.",
    ...
    },
    {
      ...
      bio: "Especialista en interfaces limpias y centradas en el usuario. Stack: React, Figma, JavaScript.",
      skills: ["React", "Figma", "JavaScript", "UI/UX"],
      social: { linkedin: "#" }
    }
  ];
