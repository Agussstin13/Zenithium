...
const Hero = () => {
  ...
  return (
    <section style={{ "--background": "100% 100% 100%" }} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="flex flex-col z-10 text-center px-4 sm:px-6 lg:px-8 md:w-[920px] lg:w-[1000px] max-w-[90%]">
        <h1 className="text-6xl md:text-8xl font-bold mb-6 animate-fade-in stagger-1">
          <span className="flex justify-center font-bold gradient-text">Zenithium</span>
          <span className="flex text-4xl md:text-6xl min-h-[5rem] font-normal">
            {displayedText}
        ...
        <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in stagger-2">
          ...
          <span className="text-accent-neon"> Especialistas en desarrollo web y cloud.</span>
        </p>
